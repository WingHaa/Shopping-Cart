...
export default function Layout({ children }: Prop) {
  return (
    <>
      <header className="sticky flex justify-evenly h-10 items-center ">
        ...
        <div className="relative">
          <div className="absolute bg-[#fdcf41] rounded-full w-4 h-4 -top-1 -right-1 flex justify-center items-center">
            5
          </div>
          <svg
